...
import static com.gmail.eugene.shchemelyov.itemshop.repository.constant.ExceptionMessageConstant.NOT_COMMIT_MESSAGE;
import static com.gmail.eugene.shchemelyov.itemshop.service.constant.RoleConstant.ADMINISTRATOR;
import static com.gmail.eugene.shchemelyov.itemshop.service.constant.RoleConstant.CUSTOMER;
...
public class AppUrlAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    private void handle(HttpServletRequest request,
        ...
        if (response.isCommitted()) {
            logger.debug("{} {}", NOT_COMMIT_MESSAGE, targetUrl);
            return;
        }
